<template>
  <div class="power_box">
    <el-button type="primary  el-icon-plus" size="small" style="margin-bottom:20px" @click="addjs"> 添加角色</el-button>
    <el-table
      ref="zxListData"
      v-loading="Loading"
      :data="roleList"
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <el-button type="primary" size="small" @click="xiugaiZx(scope.row)">修改</el-button>
          <el-button type="danger" size="small" @click="removeZX(scope.row)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
